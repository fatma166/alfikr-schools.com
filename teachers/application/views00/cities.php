...
<a href='<?php echo base_url(); ?>master/new_city' class='btn btn-success' style="display: inline-block;">
...
<table class='table table-striped'>
			<tr>
				...
				<th style="text-align: right">الاسم العربي</th>
				<th style="text-align: right">الاسم التركي</th>
	...
	?>
			<tr>
				...
				<td><?php echo $s->ar_name; ?></td>
				<td><?php echo $s->tr_name; ?></td>
				<td><a href="<?php echo base_url(); ?>master/edit_city/<?php echo $s->city_id; ?>">تعديل</a></td>
				<td><a href="<?php echo base_url(); ?>master/delete_city/<?php echo $s->city_id; ?>">حذف</a></td>
			</tr>
