...
<a href='<?php echo base_url(); ?>master/new_walad' class='btn btn-success' style="display: inline-block;">
...
<table class='table table-striped'>
			<tr>
				...
				<th style="text-align: right">اسم الولد</th>
				<th style="text-align: right">ترتيب الولد</th>
	...
	?>
			<tr>
				...
				<td><?php echo $w->trteeb; ?></td>
				<td><a href="<?php echo base_url(); ?>master/new_walad/<?php echo $w->id; ?>">تعديل</a></td>
