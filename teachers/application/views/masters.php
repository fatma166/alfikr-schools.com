...
<a href='<?php echo base_url(); ?>master/new_master' class='btn btn-success' style="display: inline-block;">
...
<table class='table table-striped'>
			<tr>
				...
				<th style="text-align: right">الجامعة</th>
	...
	?>
			<tr>
				...
				<td><?php echo $s->univ_ar_name; ?></td>
				<td><?php echo $s->start_date; ?></td>
				<td><?php echo $s->end_date; ?></td>
				<td><a href="<?php echo base_url(); ?>master/edit_master/<?php echo $s->id; ?>" >تعديل</a></td>
				<td><a href="<?php echo base_url(); ?>master/delete/masters/<?php echo $s->id; ?>">حذف</a></td>
			</tr>
