<table id="examsTable" class="table table-striped" style="width: 100%">
	...
	<?php if(!empty($query)&&(count($query)>0)){ foreach($query as $index=>$exam_arr){  ?>
		<tr>
			...
			<td> <a href="" style="color:#000"><?php echo $exam_arr['total_marks']?> </a> </td>
			...
			<td> <div class="form-check form-switch">
					<input class="form-check-input"  name="status" type="checkbox" role="switch"  id_attr="<?php echo $exam_arr['id'] ?>"  id="flexSwitchCheckDefault" <?php echo ($exam_arr['active'] == 1) ? 'checked' : ''; ?>>
				</div> </td>
