...
<table class="table">
    ...
    <td style="width: 320px;"><input type="text" value="<?php echo $this->input->get('start_date'); ?>" name="start_date" class="form-control" style="width: 300px;" id="sandbox-container1" required  autocomplete="off" placeholder="من .. " /></td>
    <td  style="width: 320px;"><input type="text" required  value="<?php echo $this->input->get('start_date'); ?>" name="end_date" class="form-control" style="width: 300px;" id="sandbox-container2"  autocomplete="off" placeholder="إلى .. " />
...
<script>
    document.getElementById('total_payments_view').innerHTML = "المبلغ الإجمالي " + <?php echo $total_payments; ?> + " ليرة تركية ";
</script>
