...
<table id="example" class="display" style="width: 100%">
	...
	?>
              <tr>
                ...
                <td> <a href=""> <img src="../../assets/images/pdf.svg" alt=""> </a></td>
				...
				<td> 
					<a href="<?php echo base_url(); ?>master/view_org_request/<?php echo $o->id; ?>">عرض</a>
					<a href="<?php echo base_url(); ?>master/delete/org_requests/<?php echo $o->id; ?>" onclick="return confirm('هل تريد حقاً حذف هذه الصفحة');" class="btn btn-danger"><span class="fa fa-trash"></span></a>
				</td>
			</tr>
		<?php } ?>
            </tbody>
