...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'teachers')">الأساتذة</button>
...
<div id="teachers" class="tabcontent "  <?php if($this->input->get('tab') == 'teachers' ){ ?> style="display: block;" <?php } ?>">
  <?php $this->load->view('course/teachers'); ?>
