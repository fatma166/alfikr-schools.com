...
<form method='post' action='<?php echo base_url(); ?>master/edit_university_done' id='form'  enctype="multipart/form-data">
<table class='table'>
	<tr>
		<td>الاسم العربي</td>
		<td><input type='text' name='ar_name' autocomplete="off" class="form-control" value="<?php echo $university->ar_name; ?>" /></td>
	</tr>
	<tr>
		<td>الاسم التركي</td>
		<td><input type='text' name='tr_name' autocomplete="off" class="form-control" value="<?php echo $university->tr_name; ?>" /></td>
	</tr>
	<tr>
		<td>المدينة</td>
		<td>
			<select name="city_id" class="form-control">
				...
				<?php foreach($cities as $c){ ?>
					<option value="<?php echo $c->city_id; ?>" <?php if($c->city_id == $university->city_id){ ?>selected<?php } ?>><?php echo $c->ar_name; ?></option>
	...
	<tr>
		...
		<td><input type="text" name="website" class="form-control" value="<?php echo $university->website; ?>" /></td>
	
	<tr>
		<td>لوغو الجامعة</td>
		<td><input type='file' name='img' />
		
		<img src="<?php echo base_url(); ?>../uploads/<?php echo $university->logo; ?>" width="100" /></td>
	</tr>
	<tr>
		<Td>التفاصيل بالعربي</td>
		<td>
			<textarea id="summernote" name='ar_details'><?php echo $university->ar_about; ?></textarea>
	...
	<tr>
		...
		<td>
			<textarea id="summernote2" name='tr_details'><?php echo $university->tr_about; ?></textarea>
