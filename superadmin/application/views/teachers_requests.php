...
<div
	...
	?>
              <tr>
                ...
                <td><?php echo $o->id; ?></td>
                <td class="name_">
                  <a href="<?php echo base_url(); ?>master/view_teacher_request/<?php echo $o->id; ?>"> <?php echo $o->first_name .' ',$o->last_name; ?> </a>
                </td>
                <td> <?php echo $o->email; ?> </td>
                <td><?php echo $o->phone; ?></td>
                <td> <a target="_blank" href="<?php echo base_url(); ?>../uploads/<?php echo $o->cv; ?>"> <img src="../../assets/images/pdf.svg" alt=""> </a></td>
