...
class Settings extends CI_Controller {
	...
	public function new_slider(){
		...
		$this->db->query("INSERT INTO slider ( image ) VALUES 
								('$target_path')");
	...
	public function info(){
		...
		$site_info = array();
		$query = $this->db->query("SELECT * FROM settings ORDER BY ordering limit 10");
	...
	public function edit_info_image(){
		...
		if($_FILES["img"]['name'] != ''){
			...
			$this->db->query("UPDATE settings SET content = '$target_path' WHERE  id = '$id'");
		}
