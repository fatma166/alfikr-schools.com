...
{
    if ($key == 0) {
        $names = ['master/time_table', 'master/books', 'master/material', 'master/exams'];
    } else if ($key == 1) {
        $names = ['master/teachers', 'master/teachers_comments', 'master/inbox', 'master/personal_info'];
    }
...
<aside class="d-lg-flex d-none">
	  ...
	  <ul class="p-0">
            <li> 
              <a href="<?php echo base_url(); ?>" style="color: #DA3837;font-weight: bold;"> <img src="<?php echo base_url(); ?>../assets/images/home.svg" alt="" style="margin-inline-end: 5px;"> الصفحة الرئيسية </a>
            </li>
          </ul>
    ...
    >
      ...
      >
        <div
          ...
          >
            <img src="../../assets/images/logo.png" alt="" width="80" height="80" class="d-lg-none d-block">
            ...
            <a href="../../administrative-section/profile/profile.html" class="d-lg-none d-block">
              <img
          ...
          <div class="offcanvas-body">
            <aside class="d-lg-flex">
              ...
              <div class="links__aside">
                <ul class="p-0">
                  <li> 
                    <a href="../../home.html" style="color: #505050;"> <img src="../../assets/images/home.svg" alt="" style="margin-inline-end: 5px;"> الصفحة الرئيسية </a>
                  </li>
              </ul>
                <div class="accordion accordion-flush" id="accordionFlushExample">
        ...
        >
          <a href="">
            <img
              src="../../assets/images/mirroring-screen.svg"
              alt="chat"
              width="40"
              height="40"
              loading="lazy"
