...
<div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                     ...
                     <div class="x_content">
					  ...
					  <div style="float: right"><h3>القسم الإداري / المدارس</h3></div>
					  <div style="float: left"><a href='<?php echo base_url(); ?>master/new_school' class='btn btn-success' style="display: inline-block;">
