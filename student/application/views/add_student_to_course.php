...
<form method="post" action="<?php echo base_url(); ?>master/add_student_to_course_done">
	<h4>إضافة طالب إلى <?php echo $course->name; ?></h4>
	<table class="table">
		<tr>
			<td width="200">اسم الطالب</td>
			<td><input type="text" class="form-control" name="student_name" onkeyup="fetch_students(this.value)" /><br />
				<select id="student_id" name="student_id" class="form-control" style="height: 40px;">
		...
		<tr>
			<td>القسط الكامل</td>
			<td><input type="text" class="form-control" name="amount" value="<?php echo $course->cost; ?>" /></td>
		</tr>
